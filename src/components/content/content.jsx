      ...
      <div className="cover shadow-lg bg-white">
        <div className="cover-bg p-3 p-lg-4 text-white">
          <div className="row">
            <div className="col-lg-4 col-md-5">
              <div className="avatar hover-effect bg-white shadow-sm p-1"><img src="images/angel.jpg" width={200} height={200} /></div>
            </div>
            <div className="col-lg-8 col-md-7 text-center text-md-start">
              <h2> ANGEL KASIHIDI </h2>
        ...
        <div className="about-section pt-4 px-3 px-lg-4 mt-1">
          <div className="row">
            <div className="col-md-6">
              ...
              <p>Hello! I’m Angel Kasihidi. I am passionate about UI/UX design and Web Design. I am a skilled Front-end Developer and master of Graphic Design tools such as Photoshop and Sketch.</p>
            </div>
            <div className="col-md-5 offset-md-1">
              <div className="row mt-2">
                ...
                <div className="col-sm-8">
                  <div className="pb-1 text-secondary">angelkasihidi@gmail.com</div>
                </div>
                <div className="col-sm-4">
                  <div className="pb-1">Phone</div>
                </div>
                <div className="col-sm-8">
                  <div className="pb-1 text-secondary">+62 813-4395-9574</div>
                </div>
                <div className="col-sm-4">
                  <div className="pb-1">Address</div>
                </div>
                <div className="col-sm-8">
                  <div className="pb-1 text-secondary">HVXR+3GJ Kasihidi Therok, Talawaan Bantik, Wori, Kabupaten Minahasa Utara, Sulawesi Utara</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="mb-2"><span>Adobe Photoshop</span>
                <div className="progress my-1">
                  <div className="progress-bar bg-success" role="progressbar" data-aos="zoom-in-right" data-aos-delay={400} data-aos-anchor=".skills-section" style={{width: '80%'}} aria-valuenow={90} aria-valuemin={50} aria-valuemax={80} />
                </div>
              </div>
        ...
        <div className="work-experience-section px-3 px-lg-4">
          ...
          <div className="timeline">
            ...
            <div className="timeline-card timeline-card-primary card shadow-sm">
              <div className="card-body">
                <div className="h5 mb-1">Data Mining <span className="text-muted h6">Subject</span></div>
                <div className="text-muted text-small mb-2">2023</div>
            ...
            <div className="timeline-card timeline-card-primary card shadow-sm">
              <div className="card-body">
                <div className="h5 mb-1">System Analys and Design <span className="text-muted h6">Subject</span></div>
                <div className="text-muted text-small mb-2">2023</div>
        ...
        <div className="education-section px-3 px-lg-4 pb-4">
          ...
          <div className="timeline">
            <div className="timeline-card timeline-card-success card shadow-sm">
              <div className="card-body">
                <div className="h5 mb-1">Bengkol Advent Primary School <span className="text-muted h6">Sulawesi Utara</span></div>
                <div className="text-muted text-small mb-2">2009 - 2015</div>
                <div>Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition.</div>
              </div>
            </div>
            <div className="timeline-card timeline-card-success card shadow-sm">
              <div className="card-body">
                <div className="h5 mb-1">Advent 4 Paal 2 Manado Junior High School <span className="text-muted h6">Sulawesi Utara</span></div>
                <div className="text-muted text-small mb-2">2015 - 2018</div>
                <div>Override the digital divide with additional clickthroughs from DevOps. Nanotechnology immersion along the information highway will close the loop on focusing solely on the bottom line.</div>
              </div>
            </div>
            <div className="timeline-card timeline-card-success card shadow-sm">
              <div className="card-body">
                <div className="h5 mb-1">Advent Klabat Manado Senior High School <span className="text-muted h6">Sulawesi Utara</span></div>
          ...
          <div className="row">
            ...
            <div className="col">
              <div className="mt-2">
                ...
                <div className="pb-2 text-secondary">HVXR+3GJ Kasihidi Therok, Talawaan Bantik, Wori, Kabupaten Minahasa Utara, Sulawesi Utara</div>
                <h3 className="h6">Phone</h3>
                <div className="pb-2 text-secondary">+02 813-4395-9574</div>
                <h3 className="h6">Email</h3>
                <div className="pb-2 text-secondary">angelkasihidi@gmail.com</div>
              </div>
            </div>
